...
var ob = ob || {};
    this.color = ob.color;
    this.hungry =(ob.hungry !== undefined) ? ob.hungry : true;
    this.status = (ob.status !== undefined) ? ob.status : 'normal';


  };
var Human = function(ob){
    var ob = ob || {};
    this.cool = (ob.cool !== undefined) ? ob.cool : false;
    this.owner = ob.owner;
